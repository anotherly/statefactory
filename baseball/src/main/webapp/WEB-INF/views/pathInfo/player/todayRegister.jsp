...
<script type="text/javascript">
	function reLoading(key) {
		...
		var res = document.todayRegister.playerNameNo.options[todayRegister.playerNameNo.selectedIndex].value;
		var abc = "?playerId=" + res.replace(/[^0-9]/g, "");

		document.todayRegister.action = "todayRegister" + abc
		document.todayRegister.submit(); 
	}
...
<body>
	...
	<form action="detailTodayStat" method="post" id="todayRegister" name="todayRegister">
		<table border="2" align="center">
			...
			<tr>
				...
				<input type="hidden" name="playerName" value="<%=teamBean.getplayerNameNoState(request)%>">
				</td>
			</tr>
			<tr>
				<td>출장여부</td>
			...
			<tr>
			 ...
			 <tr>
				<td>오늘의 포지션</td>
				<td><select name="positionToday" disabled="true">
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		function bt_ins_onclick() {//n버튼눌렀을때(읽기전용+초기화)
			...
			document.getElementById("todayRegister").reset();
		}
		function resetForm() {
