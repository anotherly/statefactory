...
public class PlayerStatCareerVo {
	...
	String year, month, day, teamId, playerId, playerName, juPosition, // 선수기본정보
			g, gs, inn, tc, po, a, e, dp, fpct, rf, // 수비지표
			ab, r, h, twoBase, thirdBase, hr, rbi, bb, so, sb, cs, avg, obp, slg, ops, // 타자지표
			w, l, hold, era, sv, svo, ip, pitcherH, pitcherR, er, pitcherHr, pitcherBb, pitcherSo, pitcherAvg, whip;// 투수지표
	Date regDate;
	...
	public String toString() {
		return "PlayerStatCareerVo [year=" + year + ", month=" + month + ", day=" + day + ", teamId=" + teamId
				+ ", playerId=" + playerId + ", playerName=" + playerName + ", juPosition=" + juPosition + ", g=" + g
				+ ", gs=" + gs + ", inn=" + inn + ", tc=" + tc + ", po=" + po + ", a=" + a + ", e=" + e + ", dp=" + dp
				+ ", fpct=" + fpct + ", rf=" + rf + ", ab=" + ab + ", r=" + r + ", h=" + h + ", twoBase=" + twoBase
				+ ", thirdBase=" + thirdBase + ", hr=" + hr + ", rbi=" + rbi + ", bb=" + bb + ", so=" + so + ", sb="
				+ sb + ", cs=" + cs + ", avg=" + avg + ", obp=" + obp + ", slg=" + slg + ", ops=" + ops + ", w=" + w
				+ ", l=" + l + ", hold=" + hold + ", era=" + era + ", sv=" + sv + ", svo=" + svo + ", ip=" + ip
				+ ", pitcherH=" + pitcherH + ", pitcherR=" + pitcherR + ", er=" + er + ", pitcherHr=" + pitcherHr
				+ ", pitcherBb=" + pitcherBb + ", pitcherSo=" + pitcherSo + ", pitcherAvg=" + pitcherAvg + ", whip="
				+ whip + ", regDate=" + regDate + "]";
	}
